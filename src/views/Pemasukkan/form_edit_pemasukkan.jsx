...
export default class form_edit_pemasukkan extends Component {
    constructor(){
        super()
        this.state = {
            jenis:[]
    ...
    render() {
        ...
        return (
            <Modal modal={modal} mode={mode} title={'Edit Pemasukkan'} idform={'edit'} action={this.save}>
                <FormGroup>
